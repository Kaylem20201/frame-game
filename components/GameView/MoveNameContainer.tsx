...
function MoveNameContainer({ input1, input2, onUserGuess }: MoveNameProps) {
  ...
  return (
    <div className="h-max grid grid-cols-2 gap-16 mx-8 my-4">
      <Button
        className="text-2xl/tight md:text-4xl/tight lg:text-8xl/tight bg-primary hover:bg-primary-400 text-black h-max font-sans font-light"
        variant="solid"
        fullWidth
      ...
      <Button
        className="text-2xl/tight md:text-4xl/tight lg:text-8xl/tight bg-primary hover:bg-primary-400 text-black h-full font-sans font-light"
        variant="solid"
        fullWidth
